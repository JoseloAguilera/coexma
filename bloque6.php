<?php 
    ...
    //var_dump($bloque1);
    if($bloque6['activo'] == '1'){
    $productos_bloque6 = getProductosBloque($_SESSION['tienda'],6,16);?>
    <section  data-aos="fade-up"
     data-aos-duration="3000" style="background:<?php echo $bloque6['fondo'] ?>!important">
        <div class="container">
            <div class="row">
                <div class="container text-center">
                  <hr>
                 <?php  //$textos = getTitulos();  ?>
                <h3 class="h3 titulo-seccion" style="color:<?php echo $bloque6['color_tit'] ?> !important"><?php echo $bloque6['titulo']  ?></h3>
                <hr>
                <p style="color:<?php echo $bloque6['color_desc'] ?> !important" > <?php echo $bloque6['descripcion']  ?> </p>
                    <div class="owl-carousel owl-theme" id="owl-bloque2">
                      <?php foreach ($productos_bloque6 as $row) { ?>
                        <div class ="item">  
