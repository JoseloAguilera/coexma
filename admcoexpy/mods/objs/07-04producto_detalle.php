	...
	if($_SERVER['REQUEST_METHOD'] == "POST") {
		...
		if (isset($_POST['nuevo'])){
			...
			if (isset($_GET['producto'])) {
				...
				$guardar = saveProducto ($_GET['producto'], $_POST['modelo'], $_POST['referencia'], $_POST['nombre'], $_POST['descripcion'], $_POST['detallada'], $precio, $valor_descuento, $_POST['categoria'], $_POST['marca'], $atributo, $destacado, $activo);
				...
				$incluir = newProducto ($_POST['referencia'],$_POST['modelo'], $_POST['nombre'], $_POST['descripcion'], $_POST['detallada'], $precio, $valor_descuento, $_POST['categoria'], $_POST['marca'], $atributo, $destacado, $activo);				
