<?php 
    ...
    //var_dump($bloque1);
    if($bloque5['activo'] == '1'){
    $productos_bloque5 = getProductosBloque($_SESSION['tienda'],5,16);?>
    <section  data-aos="fade-up"
     data-aos-duration="3000" style="background:<?php echo $bloque5['fondo'] ?>!important">
        <div class="container">
            <div class="row">
                <div class="container text-center">
                  <hr>
                 <?php  //$textos = getTitulos();  ?>
                <h3 class="h3 titulo-seccion" style="color:<?php echo $bloque5['color_tit'] ?> !important"><?php echo $bloque5['titulo']  ?></h3>
                <hr>
                <p style="color:<?php echo $bloque5['color_desc'] ?> !important" > <?php echo $bloque5['descripcion']  ?> </p>
                    <div class="owl-carousel owl-theme" id="owl-bloque1">
                      <?php foreach ($productos_bloque5 as $row) { ?>
                        <div class ="item">  
