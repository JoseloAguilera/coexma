...
<div class="col-md-12 info-contact-header">
  ...
  <?php $menu = getAllMenuCategorias( $_SESSION['tienda'], 'menu');?>
              ...
              <div class="modal-content">
                ...
                <form method="post">
                  ...
                  <div class="form-group">
                      ...
                      <div class="">
                      <div class="row text-center" id="loading-i">
                        <div class="load">
    ...
    font-weight: 600;
    padding: 10px;
">Aguarde.. Serás redireccionado en unos segundos!<br><small>O aguarde y en bre un asesor se pondrá en contacto contigo</small></p>
                    ...
                    <div class="col-md-12 blockvendedores" id="vendedores"  ></div><!-- FIN COL-12-->
