<?php 
    ...
    //var_dump($bloque1);
    if($bloque4['activo'] == '1'){
    $productos_bloque4 = getProductosBloque($_SESSION['tienda'],4,16);?>
    <section  data-aos="fade-up"
     data-aos-duration="3000" style="background:<?php echo $bloque4['fondo'] ?>!important">
        <div class="container">
            <div class="row">
                <div class="container text-center">
                  <hr>
                 <?php  //$textos = getTitulos();  ?>
                <h3 class="h3 titulo-seccion" style="color:<?php echo $bloque4['color_tit'] ?> !important"><?php echo $bloque4['titulo']  ?></h3>
                <hr>
                <p style="color:<?php echo $bloque4['color_desc'] ?> !important" > <?php echo $bloque4['descripcion']  ?> </p>
                    <div class="owl-carousel owl-theme" id="owl-bloque4">
                      <?php foreach ($productos_bloque4 as $row) { ?>
                        <div class ="item">  
