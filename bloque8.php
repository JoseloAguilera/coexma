<?php 
    ...
    //var_dump($bloque1);
    if($bloque8['activo'] == '1'){
    $productos_bloque8 = getProductosBloque($_SESSION['tienda'],8,16);?>
    <section  data-aos="fade-up"
     data-aos-duration="3000" style="background:<?php echo $bloque8['fondo'] ?>!important">
        <div class="container">
            <div class="row">
                <div class="container text-center">
                  <hr>
                 <?php  //$textos = getTitulos();  ?>
                <h3 class="h3 titulo-seccion" style="color:<?php echo $bloque8['color_tit'] ?> !important"><?php echo $bloque8['titulo']  ?></h3>
                <hr>
                <p style="color:<?php echo $bloque8['color_desc'] ?> !important" > <?php echo $bloque8['descripcion']  ?> </p>
                    <div class="owl-carousel owl-theme" id="owl-bloque4">
                      <?php foreach ($productos_bloque8 as $row) { ?>
                        <div class ="item">  
