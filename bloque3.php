<?php 
   // $bloque3= getBloque(3);
    //var_dump($bloque1);
    if($bloque3['activo'] == '1'){
    $productos_bloque3 = getProductosBloque($_SESSION['tienda'],3,16);?>
    <section  data-aos="fade-up"
     data-aos-duration="3000" style="background:<?php echo $bloque3['fondo'] ?>!important">
        <div class="container">
            <div class="row">
                <div class="container text-center">
                  <hr>
                 <?php  //$textos = getTitulos();  ?>
                <h3 class="h3 titulo-seccion" style="color:<?php echo $bloque3['color_tit'] ?> !important"><?php echo $bloque3['titulo']  ?></h3>
                <hr>
                <p style="color:<?php echo $bloque3['color_desc'] ?> !important" > <?php echo $bloque3['descripcion']  ?> </p>
                    <div class="owl-carousel owl-theme" id="owl-bloque3">
                      <?php foreach ($productos_bloque3 as $row) { ?>
                        <div class ="item">  
